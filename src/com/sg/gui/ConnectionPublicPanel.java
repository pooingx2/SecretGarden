...
public class ConnectionPublicPanel extends JPanel {
	...
	public ConnectionPublicPanel(int w, int h) {
		...
		bgImg = new JLabel[2];
		bgImg[0] = new JLabel(new ImageIcon(this.getClass().getResource(Constants.BackgroudPath.publicBG1.getPath())));
		bgImg[0].setBounds(0,0,width,height);
		bgImg[1] = new JLabel(new ImageIcon(this.getClass().getResource(Constants.BackgroudPath.publicBG2.getPath())));
		...
		label[0] = new JLabel(new ImageIcon(this.getClass().getResource(Constants.IconPath.publicIcon.getPath())));
		...
		btn[0] = new JButton(new ImageIcon(this.getClass().getResource(Constants.ButtonPath.publicBtn1.getPath())));
		btn[0].setRolloverIcon(new ImageIcon(this.getClass().getResource(Constants.ButtonPath.publicBtn2.getPath())));
